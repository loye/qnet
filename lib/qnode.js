        ...
        if (config) {
            ...
            Object.keys(config).forEach(function (k) {
                ...
                if (c.startup === 0 || c.startup === 1) {
                    try {
                        components[k] = new Component(self, c, require(resolvePath(self.context.componentsPath, k)).qnodeComponent);
                    } catch (e) { }
                }
            });
        }
    ...
    (function (proto) {
        proto.start = function () {
            if (!this.started && this._cmp && typeof this._cmp.start === 'function') {
                this._cmp.start.call(this._cmp, this.qnode, this.config);
                this.started = true;
            }
            return this;
        };
        ...
        proto.stop = function () {
            if (this.started && this._cmp && typeof this._cmp.stop === 'function') {
                this.started = false;
                this._cmp.stop.call(this._cmp, this.qnode, this.config);
            }
            return this;
        };
